...
@push('pageJs')
    ...
    <script type="text/javascript">
        // routes
        const CREATE_ROUTE = '{{ route('admin.banner.create') }}'
        const EDIT_ROUTE = '{{ route('admin.banner.edit', '_ID_') }}'
        const DELETE_ROUTE = '{{ route('admin.banner.destroy', '_ID_') }}'
