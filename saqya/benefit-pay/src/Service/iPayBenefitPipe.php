...
class iPayBenefitPipe
{
    ...
    public function __construct() {
        $this->endPoint = config('benefit.base_url');
        $this->iv = config('benefit.enc_iv');
        $this->password = config('benefit.transportal_password');
        $this->id = config('benefit.transportal_id');
        $this->key = config('benefit.terminal_resource_key');
        $this->responseURL = url('benefit/response');
        $this->errorURL = url('benefit/error');
    }
